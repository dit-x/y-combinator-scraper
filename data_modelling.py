...
def load_data(path="ycombinator.csv"):
    ...
    company_df = df[['company_id', 'company_name', 'link', 'short_description', 'founded', 'team_size', 'location', 'country', 'no_founders', 'description']]
...
def founder_data(df):
    ...
    return founder_table


def founder_social(founder_df, socials_mapper):
    f_social = founder_df.explode("social_media_links")
    ...
    founder_social_to_social = f_social[['id', 'founder_id', 'social_media_id']]
    return founder_social_to_social
...
def get_social_data(df):
    ...
    company_social_to_social = c_social[['id', 'company_id', 'social_media_id']]
...
founder_sum = founder_df.groupby('company_id')['founder_id'].count().sum()
